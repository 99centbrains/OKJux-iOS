...
//        NSString  *jpgPath = [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/yoshirt.jpg"];
//        [UIImagePNGRepresentation(userExportedImage) writeToFile:jpgPath atomically:YES];
//        NSURL *url = [[NSURL alloc] initFileURLWithPath:jpgPath];
//        
//        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[@"yoshirt://" stringByAppendingString:[url absoluteString]]]];
...
//    UIImage *imageForShare =  userExportedImage;
