...
//            _ibo_omgMapsVC = (OMGMapViewController *)[self.viewControllers objectAtIndex:0];
//            _ibo_omgVoteVC = (OMGSnapVoteViewController *)[self.viewControllers objectAtIndex:3];
//            
//            if (_ibo_omgMapsVC.newLocation){
//                [_ibo_omgVoteVC loadNewData];
//                _ibo_omgMapsVC.newLocation = NO;
//                
//            } else {
//                [_ibo_omgVoteVC reloadData];
//                
//            }
            break;
...
- (void) initCameraTaker {
    ...
    //NAVCONT
    UINavigationController *controller = (UINavigationController*)[mainSB instantiateViewControllerWithIdentifier: @"seg_cameraNavigationToolBar"];
...
//                                      NSLocalizedString(@"PROMPT_REMIX_TITLE", nil)
//                                      message:NSLocalizedString(@"PROMPT_REMIX_BODY", nil) preferredStyle:UIAlertControllerStyleAlert];
//    
//    
//    //ACTION
//    UIAlertAction *actionShare = [UIAlertAction actionWithTitle:NSLocalizedString(@"PROMPT_REMIX_ACTION_01", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
//        
//        UIStoryboard *mainSB = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]];
//        
//
//        ShareViewController *vc = (ShareViewController *)[storyboard instantiateViewControllerWithIdentifier:@"ShareViewController"];
//        vc.userExportedImage = [UIImage imageWithData:UIImagePNGRepresentation(image)];
//        
//        //NAVCONT
//        UINavigationController *controller = (UINavigationController*)[mainSB instantiateViewControllerWithIdentifier: @"seg_cameraNavigationToolBar"];
//        [controller setViewControllers:@[vc]];
//        
//        [[CBJSONDictionary shared] parse_trackAnalytic:@{@"RE":@"Share"} forEvent:@"Explore"];
//        
//        [self presentViewController:controller animated:YES completion:nil];
//        
//        if (_ibo_lightboxView){
//            [self omgSnapDismissLightBox:nil];
//        }
//        
//    }];
//    
//    
//    //ACTION
//    UIAlertAction *actionRemix = [UIAlertAction actionWithTitle:NSLocalizedString(@"PROMPT_REMIX_ACTION_02", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
//        
//        UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//        
//        
...
//        
//        //NAVCONT
//        UINavigationController *controller = (UINavigationController*)[storyboard instantiateViewControllerWithIdentifier: @"seg_cameraNavigationToolBar"];
//        [controller setViewControllers:@[playVC]];
//        
//        [self presentViewController:controller animated:YES completion:nil];
//        
//        [[CBJSONDictionary shared] parse_trackAnalytic:@{@"RE":@"Remix"} forEvent:@"Explore"];
//        
//        if (_ibo_lightboxView){
//            [self omgSnapDismissLightBox:nil];
//        }
...
//    
//    
//    UIAlertAction *actionnm = [UIAlertAction actionWithTitle:NSLocalizedString(@"PROMPT_REMIX_CANCEL", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
//        //
//        
//    }];
//    
...
//    [actionSheet addAction:actionRemix];
//    [actionSheet addAction:actionnm];
//    
//    [self presentViewController:actionSheet animated:YES completion:nil];
