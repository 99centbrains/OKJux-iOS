...
//        NSMutableArray *tempArray = [objects mutableCopy];
//        
//        NSLog(@"FOUND Vote OBJECTS %lu", (unsigned long)[objects count]);
//        
//        NSArray *likedArrayItems = [objects filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(id object, NSDictionary *bindings) {
//            PFObject *lol = (PFObject *)object;
//            NSArray *likes = [lol objectForKey:@"likes"];
//            return [likes containsObject:[DataHolder DataHolderSharedInstance].userObject.objectId];
//        }]];
//        
//        NSArray *disLikedArrayItems = [objects filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(id object, NSDictionary *bindings) {
//            PFObject *lol = (PFObject *)object;
//            NSArray *likes = [lol objectForKey:@"dislikes"];
//            return [likes containsObject:[DataHolder DataHolderSharedInstance].userObject.objectId];
//        }]];
//        
//        [tempArray removeObjectsInArray:likedArrayItems];
//        [tempArray removeObjectsInArray:disLikedArrayItems];
//        
//        objects = [tempArray copy];
//        
//        NSSortDescriptor *dateDescriptor = [NSSortDescriptor sortDescriptorWithKey:@"createdAt" ascending:NO];
//        NSArray *sortDescriptors = [NSArray arrayWithObject:dateDescriptor];
//        _snapsArray = [objects sortedArrayUsingDescriptors:sortDescriptors];
...
//    
//    SwitchHeaderCollectionReusableView *header = (SwitchHeaderCollectionReusableView *)[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"switchHeader" forIndexPath:indexPath];
//    
//    
//    
//    return header;
...
- (NSString *) getUserTimeZone:(PFObject*)snap{
    ...
    // DISTANCE
     CLLocation *locationCurrent = [[CLLocation alloc] initWithLatitude:[DataHolder DataHolderSharedInstance].userGeoPoint.latitude longitude:[DataHolder DataHolderSharedInstance].userGeoPoint.longitude];
    ...
    if (!isMetric){
     ...
     //cell.ibo_uploadDate.text = [cell.ibo_uploadDate.text stringByAppendingString:miles];
