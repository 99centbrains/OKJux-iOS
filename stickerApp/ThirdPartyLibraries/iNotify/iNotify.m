...
- (void)downloadedNotificationsData
{
    ...
    if (notificationKey)
    {
       ...
       // NSString *alertType = [notification objectForKey:iNotifyTypeKey];
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    NSString *actionURL = [notification objectForKey:iNotifyActionURLKey];
    NSString *actionType = [notification objectForKey:iNotifyTypeKey];
    ...
    else
    {
        ...
        if ([actionType isEqualToString:@"link"] || [actionType isEqualToString:@"site"]){
            
             NSLog(@"URL: %@", actionType);
            //[self.delegate iNotifyWithURLType:actionType withURL:actionURL];
